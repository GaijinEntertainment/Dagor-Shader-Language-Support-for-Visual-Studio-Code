include "test_inc_1.sh"             // resolves to folder_1/test_inc_1.sh, because of common_inc_dirs.blk
include "test_inc_3.sh"             // resolves to folder_2/test_inc_3.sh, because of _build/shaders_pc11.blk
include_optional "test_inc_2.sh"    // resolves to folder_1/test_inc_2.sh, because of common_inc_dirs.blk
hlsl {
